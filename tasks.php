            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                 ...
                 <input type="text" class="form-control" id="title" required="" name="title" placeholder="Please Enter Task Title">
            ...
            <!-- /.row -->
              ...
              <div class="col-12 col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <select multiple id="stat" name="stat"  class="form-control select2" style="">
