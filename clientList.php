        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="clientReports.php">View Reports</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Upload client List</h3>
          ...
          <!-- /.card-header -->
          <form action="clientList.php" method="POST" enctype="multipart/form-data">
          <div class="card-body">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="title">File Name</label>
                 <input type="text" name="custom_name" id="custom_name" required required class="form-control" placeholder="Enter file name">
                
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                   <label for="user">Filed By:</label>
          
                      <input type="text" name="person_filing" id="person_filing" required placeholder="Filed By:" required class="form-control">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="start">Filing Date</label>
                 <input type="Date" name="filing_date" id="filing_date" required class="form-control">
                                </div>
                <!-- /.form-group -->
<div class="form-group">
                  <label for="descri">Upload file</label>
...
<!--                </div>-->
          ...
          <div class="card-footer">
                  <button type="submit" name="btn" value="Upload" class="btn btn-primary" >Submit</button>
                </div>
<?php
...
$username = "ejrkjatn_root";
$password = "Ishfinal";
$database = "ejrkjatn_ishfinal";
...
$personFiling = $_POST['person_filing'];
...
// Prepare and execute the SQL statement to insert the file into the database
$stmt = $conn->prepare("INSERT INTO clients (custom_name, person_filing, filing_date, file_data, file_type, file_size, file_extension, original_file_name) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
$stmt->bind_param("sssssiss", $customName, $personFiling, $filingDate, $fileData, $fileType, $fileSize, $fileExtension, $originalFileName);
$stmt->execute();

// Check if the file was inserted successfully
