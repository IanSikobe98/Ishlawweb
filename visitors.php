...
if(!isset($_COOKIE["addvis"]) || ($_COOKIE["addvis"])!="addvisitors"){
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item active">Visitors Form</li>
                <li class="breadcrumb-item"><a href="roster.php">View Visitors</a></li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="visitor" class="form-control" required="" id="parties" placeholder="Please enter the first name of the visitor">

                    </div>
                    <!-- /.form-group -->
                    <div class="form-group">
                      <label>Mobile</label>
                      <input type="number" class="form-control" name="mobile" required="" id="bile" placeholder="Enter the mobile number">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="lname" required="" id="file" placeholder="please enter the last name of the visitor">
                    </div>
                    <!-- /.form-group -->
                    <div class="form-group">
                      <label>Purpose of visit</label>
                      <input type="Text" class="form-control" id="case" required="" name="case" placeholder="what is the purpose of visit">
                ...
                <div class="row">
                  <div class="col-12 col-sm-6">
                    <div class="form-group">
                      <label>To be assisted By:</label>
                      <input type="Text" class="form-control" id="client" required="" name="client" placeholder="Who are you going to visit">
                  ...
                  <div class="col-12 col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="select2-purple">
                        <input type="Date" name="date" class="form-control" required="" id="by" placeholder="Enter Name">
                      </div>
                    </div>
                    <!-- /.form-group -->
                  </div>
