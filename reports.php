        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="viewReports.php">View Reports</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Upload work report</h3>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                 ...
                 <input type="datetime-local" name="filing_date" id="filing_date" required class="form-control">
                                </div>
                <!-- /.form-group -->
<div class="form-group">
...
$stmt = $conn->prepare("INSERT INTO files (custom_name, person_filing, filing_date, file_data, file_type, file_size, file_extension, original_file_name) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
