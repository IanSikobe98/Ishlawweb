  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="court_attendance.php" class="nav-link">Submit New Form</a>
      </li>
      <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Form.." title="Type in a name">
<!--      <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>-->
      <script>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Submitted Forms</h3>
...
<script src="services/cases/fetchCourtForms.js" type="text/javascript"></script>
